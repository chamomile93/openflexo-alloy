...
@ModelEntity
@ImplementationClass(AddAlloyLine.AddAlloyLineImpl.class)
@XMLElement
@FML("AddAlloyLine")
public interface AddAlloyLine extends AlloyAction<AlloyLine> {
	...
	public static abstract class AddAlloyLineImpl extends TechnologySpecificActionDefiningReceiverImpl<AlloyModelSlot, AlloyText, AlloyLine>
			implements AddAlloyLine {

		private static final Logger logger = Logger.getLogger(AddAlloyLine.class.getPackage().getName());
		...
		@Override
		public AlloyLine execute(RunTimeEvaluationContext evaluationContext) {
	...
	public static class LineNumberBindingIsRequiredAndMustBeValid extends BindingIsRequiredAndMustBeValid<AddAlloyLine> {
		public LineNumberBindingIsRequiredAndMustBeValid() {
			super("'lineNumber'_binding_is_required_and_must_be_valid", AddAlloyLine.class);
		}

		@Override
		public DataBinding<Integer> getBinding(AddAlloyLine object) {
